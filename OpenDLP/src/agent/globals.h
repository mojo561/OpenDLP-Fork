...
//NEW: 2018.07.28 - Show everything EXCEPT C:\Users
int showdir_nousers( const char* );
...
/*NEW: 2018.07.29
 * - these are freed in whitelist.c, if you with to use these further along in the program, make sure you account for this..
*/
dirs *curr_dir;
dirs *head_dir;
//NEW: 2018.07.29 (these are also freed in whitelist.c)
dirs *gdpr_curr_dir;
dirs *gdpr_head_dir;
